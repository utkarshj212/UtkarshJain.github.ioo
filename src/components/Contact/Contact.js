            ...
            <ul className="home-about-social-links">
              <li className="social-icons-contect first">
                ...
                <span className="link-text-css" onClick={() => setCallme(true)}>
                  +91 7340078734<span style={{ opacity: 0 }}>+91 7340078734</span>
                </span>
              </li>
              <li className="social-icons-contect third">
                ...
                <span
                  ...
                  onClick={() => setModalShow(true)}
                >
                  utkarsh21299@gmail.com
                  <span style={{ opacity: 0 }}></span>
                </span>
              </li>
              <li className="social-icons-contect fifth">
                <a
                  href="https://github.com/utkarshj212"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
          ...
          <Col md={6} className="home-about-social">
            <ul className="home-about-social-links">
              <li className="social-icons-contect second">
                <a
                  href="https://www.linkedin.com/in/utkarsh-jain-a068b921b/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
                ...
                <a
                  ...
                  href="https://www.linkedin.com/in/utkarsh-jain-a068b921b/"
                >
                  linkedin.com/in/utkarsh-jain-a068b921b/
                  <span style={{ opacity: 0 }}>||</span>
                </a>
              </li>
